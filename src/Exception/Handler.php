...
class Handler
{
    ...
    protected $exceptionsByStatusCode = [
        ...
        400 => 'BadRequest',
        // Invalid Pushy API key provided
        401 => 'Unauthorized',
        // Parameters were valid but request failed
        402 => 'InvalidRequest',
        // The requested item doesn't exist
        404 => 'NotFound',
        // Something went wrong on Pushy's end
        500 => 'ServerError',
        502 => 'ServerError',
        503 => 'ServerError',
        504 => 'ServerError',
     ...
     * @return void
     * @throws \Jlorente\Pushy\Exception\PushyApiException
     */
    ...
    protected function handleException($message, $statusCode, $errorType, $errorCode, $missingParameter, $rawOutput)
    {
        ...
        $class = "\\Jlorente\\Pushy\\Exception\\{$class}Exception";
